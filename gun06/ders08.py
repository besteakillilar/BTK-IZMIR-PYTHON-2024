...
class Kitap():
    ...
    def __str__(self):
        return self.ad   #Kitabı çağırdığında bellekteki adresi yerine isim bilgisinin gelmesi için.
...
def kitapListesineEkle():
    ...
    kitap = Kitap(kitap_adi, kitap_yazar, kitap_sayfa, kitap_yili)  #Kitap oluşturma adımı.
    degerler = vars(kitap)
    kitap_listesi.append(degerler)
    kitaplar.append(kitap)

#rty-except ekleyerek uzak bir veri tabanından programı durmadan çalışacak şekilde hatalsrı görmemize yardımcı olabilir.
